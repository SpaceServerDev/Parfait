...
use pocketmine\level\plutobiome\Biome;
use pocketmine\level\ChunkManager;
use pocketmine\level\generator\normal\plutobiome\BiomeSelector;
use pocketmine\level\generator\Generator;
use pocketmine\level\generator\noise\Simplex;
use pocketmine\level\generator\object\OreType;
use pocketmine\level\generator\populator\PlutoGroundCover as GroundCover;
...
class Pluto extends Generator{

	/** @var Populator[] */
	private $populators = [];
	/** @var int */
	private $waterHeight = 40;
	...
	public function init(ChunkManager $level, Random $random) : void{
		...
		$ores->setOreTypes([
			...
			new OreType(BlockFactory::get(Block::PRISMARINE,1), 20, 32, 0, 128),
			new OreType(BlockFactory::get(Block::SOUL_SAND), 10, 16, 0, 128)
		]);
		...
		for($x = 0; $x < 16; ++$x){
			for($z = 0; $z < 16; ++$z){
				...
				for($y = 0; $y < 128; ++$y){
					...
					if($noiseValue > 0){
						$chunk->setBlockId($x, $y, $z, Block::PRISMARINE);
