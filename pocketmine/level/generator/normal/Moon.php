...
use pocketmine\level\moonbiome\Biome;
use pocketmine\level\ChunkManager;
use pocketmine\level\generator\normal\moonbiome\BiomeSelector;
use pocketmine\level\generator\Generator;
use pocketmine\level\generator\noise\Simplex;
use pocketmine\level\generator\object\OreType;
use pocketmine\level\generator\populator\MoonGroundCover as GroundCover;
...
class Moon extends Generator{
	...
	public function init(ChunkManager $level, Random $random) : void{
		...
		$ores->setOreTypes([
			...
			new OreType(BlockFactory::get(Block::IRON_ORE), 20, 9, 0, 64),
			new OreType(BlockFactory::get(Block::REDSTONE_ORE), 8, 8, 0, 16),
			new OreType(BlockFactory::get(Block::LAPIS_ORE), 10, 9, 0, 60),
			new OreType(BlockFactory::get(Block::GOLD_ORE), 5, 8, 0, 32),
			new OreType(BlockFactory::get(Block::DIAMOND_ORE), 1, 8, 0, 20),
			new OreType(BlockFactory::get(Block::SLIME_BLOCK), 1, 7, 0, 16),
			new OreType(BlockFactory::get(Block::END_STONE), 20, 32, 0, 128),
		]);
